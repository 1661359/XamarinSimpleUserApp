    ...
    public class PlaceDetailsController : ApiController
    {
        ...
        public PlaceDetails Get(Guid id)
        {
            return new PlaceDetails()
            {
                ...
                PicturesUrls = new List<PictureSource>
                {
                    new PictureSource() {Url =  "http://netdna.webdesignerdepot.com/uploads/2013/12/featured5.jpg"},
                    new PictureSource() {Url =  "http://cdn.spectator.co.uk/content/uploads/2015/10/HiRes1.jpg"}
                },
                Text =
